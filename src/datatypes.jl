...
- `meas_default::Dict{Symbol}` Default keyword argument settings for measures.
...
function InfiniteModel(; seed = false, kwargs...)
    ...
    return InfiniteModel(# Measures
                         ...
                         Dict{Int, Bool}(),
                         Dict(Symbol("eval_method") => nothing,
                              Symbol("num_supports") => 50,
                              Symbol("weight_func") => _w,
                              Symbol("name") => "measure",
                              Symbol("use_existing_supports") => false,
                              Symbol("call_from_expect") => false),
                         # Parameters
