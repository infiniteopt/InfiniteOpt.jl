...
[here](https://jump.dev/JuMP.jl/v0.21.9/tutorials/Getting%20started/getting_started_with_JuMP/).
...
[`@objective`](https://jump.dev/JuMP.jl/v0.21.9/reference/objectives/#JuMP.@objective):
 ```jldoctest quick
