...
# [Constraints](@id constr_docs)
A guide for constraints in `InfiniteOpt`. See the respective 
[technical manual](@ref constr_manual) for more details.
...
## Basic Usage
Principally, the 
[`@constraint`](https://jump.dev/JuMP.jl/v0.21.9/reference/constraints/#JuMP.@constraint) 
...
!!! note
    ...
    see [JuMP's constraint documentation](https://jump.dev/JuMP.jl/v0.21.9/manual/constraints/#Constraints) 
...
!!! note
    ...
    [`JuMP`'s constraint documentation](https://jump.dev/JuMP.jl/v0.21.9/manual/constraints/#Vectorized-constraints). 
...
[`JuMP`'s constraint container documentation](https://jump.dev/JuMP.jl/v0.21.9/manual/constraints/#Constraint-containers).
...
```
See [`JuMP`'s constraint documentation](https://jump.dev/JuMP.jl/v0.21.9/manual/constraints/) 
...
[`JuMP.ScalarConstraint`](https://jump.dev/JuMP.jl/v0.21.9/reference/constraints/#JuMP.ScalarConstraint)s 
and [`JuMP.VectorConstraint](https://jump.dev/JuMP.jl/v0.21.9/reference/constraints/#JuMP.VectorConstraint)s. 
...
The [`@constraint`](https://jump.dev/JuMP.jl/v0.21.9/reference/constraints/#JuMP.@constraint) 
and [`@SDconstraint`](https://jump.dev/JuMP.jl/v0.21.9/reference/constraints/#JuMP.@SDconstraint) 
