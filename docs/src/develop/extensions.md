...
5. If appropriate and NOT a [`JuMPBackend`](@ref), extend the following:
    ...
    - [`JuMP.solution_summary`](@ref JuMP.solution_summary(::AbstractTransformationBackend))
...
13. Extend [InfiniteOpt.update_start_value`](@ref update_start_value(::AbstractTransformationBackend, ::Any, ::Any)) to enable incremental start value updates.
