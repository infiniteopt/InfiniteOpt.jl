...
infinite_domain(::Array{<:DependentParameterRef})
...
has_supports(::Array{<:DependentParameterRef})
num_supports(::DependentParameterRef)
num_supports(::Array{<:DependentParameterRef})
supports(::DependentParameterRef)
supports(::Array{<:DependentParameterRef})
...
set_infinite_domain(::Array{<:DependentParameterRef},::InfiniteArrayDomain)
JuMP.set_lower_bound(::DependentParameterRef,::Real)
JuMP.set_upper_bound(::DependentParameterRef,::Real)
add_supports(::Array{<:DependentParameterRef},::Vector{<:Array{<:Real}})
set_supports(::Array{<:DependentParameterRef},::Vector{<:Array{<:Real}})
delete_supports(::Array{<:DependentParameterRef})
generate_and_add_supports!(::Array{<:DependentParameterRef},::InfiniteArrayDomain)
fill_in_supports!(::Array{<:DependentParameterRef})
JuMP.delete(::InfiniteModel,::Array{<:DependentParameterRef})
```
