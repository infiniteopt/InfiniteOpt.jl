...
@testset "Definition" begin
    ...
    @testset "Default" begin
        @test DualDict{String, Int, Symbol}() isa DualDict{String, Int, Symbol}
    end
    # test the tuple constructor
    @testset "Tuple" begin
        @test DualDict{String, Int, Symbol}(("ab" => :a, 3 => :w)) isa DualDict
    end
...
@testset "Basic Extensions" begin
    dd1 = DualDict{String, Int, Symbol}("ab" => :a, 3 => :w)
    # test Base.:(==)
    @testset "Base.:(==)" begin
        @test dd1 == DualDict{String, Int, Symbol}("ab" => :a, 3 => :w)
    end
    # test Base.copy
    @testset "Base.copy" begin
        @test copy(dd1) == DualDict{String, Int, Symbol}("ab" => :a, 3 => :w)
    end
    # test Base.in
    ...
    @testset "Base.isempty" begin
        @test !isempty(dd1)
        @test isempty(DualDict{Int, Float64, Symbol}())
    end
end
...
@testset "Modifcation" begin
    ...
    @testset "Base.empty!" begin
        dd1 = DualDict{String, Int, Symbol}("ab" => :a, 3 => :w)
        @test empty!(dd1) == DualDict{String, Int, Symbol}()
    end
    # test Base.delete!
    @testset "Base.delete!" begin
        dd1 = DualDict{String, Int, Symbol}("ab" => :a, 3 => :w)
        @test delete!(dd1, "ab") == DualDict{String, Int, Symbol}(3 => :w)
        @test delete!(dd1, 3) == DualDict{String, Int, Symbol}()
    end
end
...
@testset "Iteration" begin
    ...
    dd3 = DualDict{String, Int, Symbol}("ab" => :a)
    dd4 = DualDict{String, Int, Symbol}()
    dd5 = DualDict{String, Int, Symbol}("ab" => :a, 3 => :w, "vf" => :b, 42 => :k)
...
@testset "Showing" begin
    ...
    @testset "show_string" begin
        ...
        @test IC.show_string(dd2) == "DualDict{String,Int64,Symbol} with 1 entry:\n  3 => :w"
    end
    # test Base.show (REPL)
    @testset "Base.show (REPL)" begin
        show_test(REPLMode, dd1, "DualDict{String,Int64,Symbol} with 0 entries:")
        show_test(REPLMode, dd2, "DualDict{String,Int64,Symbol} with 1 entry:\n  3 => :w")
    end
    # test Base.show (IJulia)
    @testset "Base.show (IJulia)" begin
        show_test(IJuliaMode, dd1, "DualDict{String,Int64,Symbol} with 0 entries:")
        show_test(IJuliaMode, dd2, "DualDict{String,Int64,Symbol} with 1 entry:\n  3 => :w")
    end
end
